Vue.component('estimate-remaining', {
	props: {
	...
	methods: {
		...
		submitForm: function (event) {
			...
			const result = loanHelper.calculatePayoffTime(this.loanAmount, this.totalPayAmount, this.feeAmount, this.interestRate, this.frequency);
				...
				<div class="container">
					<div class="row">
						...
						<span class="col-md-auto">
							<label>${result.numberOfPayments}</label>
						</span>
					</div>
					<div class="row">
						<span class="col">
						...
						<span class="col-md-auto">
							<label>${result.numberOfMonths}</label>
						</span>
					</div>
					<div class="row">
						<span class="col">
						...
						<span class="col-md-auto">
							<label>${result.finalPaymentAmount.toLocaleString(undefined, { minimumFractionDigits: 2,  maximumFractionDigits: 2 })}</label>
						</span>
					</div>
					<div class="row">
						<span class="col">
						...
						<span class="col-md-auto">
							<label>${result.totalInterest.toLocaleString(undefined, { minimumFractionDigits: 2,  maximumFractionDigits: 2 })}</label>
						</span>
					</div>
				</div>
			`;
	...
	template: `
		<div>
			<b-form class="form" id="estimateRemainingForm">
				<b-form-group
					label="Loan amount"
